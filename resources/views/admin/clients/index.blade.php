...
@section('content')
    <header class="mb-10 flex justify-between items-center">
        ...
        <a href="{{ route('admin.clients.create') }}" class="flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-bold hover:brightness-110 transition-colors shadow-lg">
                ...
                @forelse($clients as $client)
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <a href="{{ route('admin.clients.edit', $client) }}" class="inline-flex items-center p-2 text-primary hover:bg-primary/10 rounded-lg transition-colors">

...
@section('title', 'Novo Porto - Painel Administrativo')

@section('content')
    <header class="mb-10 flex justify-between items-center">
        <div>
            <h2 class="text-[2.75rem] font-bold tracking-tight text-on-surface leading-tight mb-2">Novo Porto</h2>
            <p class="text-on-surface-variant font-medium">Cadastre um novo porto de atuação.</p>
        </div>

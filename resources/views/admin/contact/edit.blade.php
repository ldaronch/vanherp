...
@section('title', 'Contato e Localização - Painel Administrativo')

@section('content')
    <header class="mb-10 flex justify-between items-center">
        <div>
            <h2 class="text-[2.75rem] font-bold tracking-tight text-on-surface leading-tight mb-2">Contato e Localização</h2>
            <p class="text-on-surface-variant font-medium">Gerencie os dados de contato e endereço da empresa.</p>
        </div>
    </header>
    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-sm p-8 border border-slate-100 max-w-5xl mx-auto">
        <form action="{{ route('admin.contact.update') }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-50">
                <div class="md:col-span-2">
                    <label for="address" class="block text-sm font-bold text-on-surface-variant mb-2">Endereço Completo</label>

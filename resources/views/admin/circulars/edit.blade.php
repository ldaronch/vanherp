    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-sm p-8 border border-slate-100 max-w-4xl mx-auto">
        <form action="{{ route('admin.circulars.update', $circular) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="attachments" class="block text-sm font-bold text-on-surface-variant mb-2">Anexar Novos Arquivos</label>
                    ...
                    <p class="mt-1 text-[10px] text-slate-400 font-medium">Selecione novos arquivos para adicionar à lista atual.</p>
                        ...
                        @foreach($circular->attachments as $attachment)
                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-100">
                                <div class="flex items-center gap-2 overflow-hidden">
                                    <span class="material-symbols-outlined text-secondary text-sm">attach_file</span>

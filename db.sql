...
INSERT INTO `banners` (`id`, `title`, `subtitle`, `image`, `link`, `is_active`, `order`, `created_at`, `updated_at`) VALUES
	(1, 'Conheça nossa empresa', 'São informações importantes para você!', 'banners/iAcdR7tCo4FfNLZaJJ6G7Zdp8zsBIlqf7ZCAj8WY.png', NULL, 1, 0, '2026-05-08 04:46:14', '2026-05-08 04:46:14');
...
-- Copiando dados para a tabela vanherp.categories: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vanherp.contents: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vanherp.migrations: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vanherp.ports: ~0 rows (aproximadamente)
...
INSERT INTO `posts` (`id`, `category_id`, `date`, `title`, `header_line`, `slug`, `content`, `image`, `is_published`, `is_featured`, `created_at`, `updated_at`) VALUES
	(1, 1, '2026-05-09', 'Título da notícia para cadastro', 'Linha de cabeçalho para notícia de destaque um texto atoa', 'titulo-news', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec dui non lectus ornare posuere eu in lorem. Fusce sed neque vitae nulla volutpat imperdiet eleifend tincidunt justo. Praesent id ligula id est pretium vulputate vitae id nulla. Vestibulum augue lectus, porttitor at quam non, fermentum bibendum tellus. Mauris cursus eleifend ultrices. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu mauris facilisis, semper ligula vitae, condimentum urna. Vivamus neque quam, tristique et sem id, lacinia porttitor mi. Pellentesque egestas arcu non tortor tristique laoreet. Etiam risus quam, maximus eget rutrum ac, semper sit amet odio. Vestibulum vestibulum maximus diam, ut mattis tortor tristique et. Suspendisse mollis dui quis mattis dignissim. Phasellus fringilla, velit quis maximus mattis, dolor ex euismod metus, interdum accumsan sem leo at leo. Maecenas condimentum lacus non massa pulvinar efficitur.</p><p>Quisque non elementum augue, in fringilla velit. Duis sodales laoreet tellus, quis maximus nisl lacinia sed. Maecenas pellentesque, erat sit amet dapibus fringilla, tellus risus elementum sem, sed ultricies arcu sem quis lacus. Duis ac pretium nulla. Phasellus maximus luctus dictum. Aliquam hendrerit ut diam eget vestibulum. Duis non magna a arcu aliquet ultrices. Donec maximus tincidunt commodo. Nam in sapien at erat dapibus pretium non sed velit. Mauris id erat elementum, efficitur arcu vitae, iaculis tellus. In porta eget risus in ultricies. Nam suscipit libero vitae porttitor imperdiet. Sed non pretium turpis.</p>', 'posts/Vf9GhE13yxv7YjDWin8qHCKjyDqOwUWILVd6hGnL.jpg', 1, 1, '2026-05-11 01:29:00', '2026-05-11 01:29:00'),
	(2, 1, '2026-05-09', 'Título da notícia para cadastro', 'Linha de cabeçalho para notícia de destaque um texto atoa', 'titulo-news1', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec dui non lectus ornare posuere eu in lorem. Fusce sed neque vitae nulla volutpat imperdiet eleifend tincidunt justo. Praesent id ligula id est pretium vulputate vitae id nulla. Vestibulum augue lectus, porttitor at quam non, fermentum bibendum tellus. Mauris cursus eleifend ultrices. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu mauris facilisis, semper ligula vitae, condimentum urna. Vivamus neque quam, tristique et sem id, lacinia porttitor mi. Pellentesque egestas arcu non tortor tristique laoreet. Etiam risus quam, maximus eget rutrum ac, semper sit amet odio. Vestibulum vestibulum maximus diam, ut mattis tortor tristique et. Suspendisse mollis dui quis mattis dignissim. Phasellus fringilla, velit quis maximus mattis, dolor ex euismod metus, interdum accumsan sem leo at leo. Maecenas condimentum lacus non massa pulvinar efficitur.</p><p>Quisque non elementum augue, in fringilla velit. Duis sodales laoreet tellus, quis maximus nisl lacinia sed. Maecenas pellentesque, erat sit amet dapibus fringilla, tellus risus elementum sem, sed ultricies arcu sem quis lacus. Duis ac pretium nulla. Phasellus maximus luctus dictum. Aliquam hendrerit ut diam eget vestibulum. Duis non magna a arcu aliquet ultrices. Donec maximus tincidunt commodo. Nam in sapien at erat dapibus pretium non sed velit. Mauris id erat elementum, efficitur arcu vitae, iaculis tellus. In porta eget risus in ultricies. Nam suscipit libero vitae porttitor imperdiet. Sed non pretium turpis.</p>', 'posts/Vf9GhE13yxv7YjDWin8qHCKjyDqOwUWILVd6hGnL.jpg', 1, 1, '2026-05-11 01:29:00', '2026-05-11 01:29:00'),
	(3, 1, '2026-05-09', 'Título da notícia para cadastro', 'Linha de cabeçalho para notícia de destaque um texto atoa', 'titulo-news2', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec dui non lectus ornare posuere eu in lorem. Fusce sed neque vitae nulla volutpat imperdiet eleifend tincidunt justo. Praesent id ligula id est pretium vulputate vitae id nulla. Vestibulum augue lectus, porttitor at quam non, fermentum bibendum tellus. Mauris cursus eleifend ultrices. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu mauris facilisis, semper ligula vitae, condimentum urna. Vivamus neque quam, tristique et sem id, lacinia porttitor mi. Pellentesque egestas arcu non tortor tristique laoreet. Etiam risus quam, maximus eget rutrum ac, semper sit amet odio. Vestibulum vestibulum maximus diam, ut mattis tortor tristique et. Suspendisse mollis dui quis mattis dignissim. Phasellus fringilla, velit quis maximus mattis, dolor ex euismod metus, interdum accumsan sem leo at leo. Maecenas condimentum lacus non massa pulvinar efficitur.</p><p>Quisque non elementum augue, in fringilla velit. Duis sodales laoreet tellus, quis maximus nisl lacinia sed. Maecenas pellentesque, erat sit amet dapibus fringilla, tellus risus elementum sem, sed ultricies arcu sem quis lacus. Duis ac pretium nulla. Phasellus maximus luctus dictum. Aliquam hendrerit ut diam eget vestibulum. Duis non magna a arcu aliquet ultrices. Donec maximus tincidunt commodo. Nam in sapien at erat dapibus pretium non sed velit. Mauris id erat elementum, efficitur arcu vitae, iaculis tellus. In porta eget risus in ultricies. Nam suscipit libero vitae porttitor imperdiet. Sed non pretium turpis.</p>', 'posts/Vf9GhE13yxv7YjDWin8qHCKjyDqOwUWILVd6hGnL.jpg', 1, 1, '2026-05-11 01:29:00', '2026-05-11 01:29:00');
...
-- Copiando dados para a tabela vanherp.users: ~0 rows (aproximadamente)
